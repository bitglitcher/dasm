...
{
       0,    48,    48,    49,    53,    55,    57,    61,    70,    79,
      93,    92,   111,   113,   115,   117,   121,   127
};
#endif
...
{
  "$end", "error", "$undefined", "OPERATION", "SEMICOLON", "DEF", "ALLOC",
  "IDENTIFIER", "INS", "NUMBER", "','", "';'", "'{'", "'}'", "':'",
  "$accept", "commands", "command", "arguments", "instruction", "$@1",
  "defenition_exp", "defenition", "label", YY_NULLPTR
};
#endif
...
{
       2,     0,     1,     0,    10,     3,     4,     5,     6,     0,
      17,     0,    12,     0,    13,     7,     0,    16,    14,    15,
       0,    11,     8,     9
};
...
{
       2,    22,     4,    23,     9,     3,    12,     4,    17,     0,
      18,    14,    10,    20,    21,    19,     4,    15
};

static const yytype_int8 yycheck[] =
{
       0,     7,     7,     9,    12,     5,     9,     7,    13,    -1,
      13,     9,    14,    10,    11,    13,     7,     7
};
...
{
       0,    16,     0,     5,     7,    17,    19,    22,    23,    12,
      14,    20,    19,    21,    23,     7,    18,    13,    19,    23,
      10,    11,     7,     9
};
