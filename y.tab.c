...
{
  "$end", "error", "$undefined", "OPERATION", "SEMICOLON", "DEFINE",
  "IDENTIFIER", "INS", "NUMBER", "':'", "$accept", "commands", "command",
  "instruction", "defenition", "label", YY_NULLPTR
};
#endif
